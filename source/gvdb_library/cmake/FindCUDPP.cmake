...
# 	else()
# 		message ( STATUS "  Locating: libcudpp.so, CUDA: ${CUDA_SUFFIX}")
# 	endif()
#      set ( OK_REL "0" )		
...
#      set ( OK_DBG "0" )	
# 	_FIND_FILE ( LIB1_DEBUG CUDPP_LIB_DIR "cudpp_${MSVC_VERSION}${CUDA_SUFFIX}x64d.lib" "libcudpp.so" OK_DBG )	        	
# 	_FIND_FILE ( LIB2_DEBUG CUDPP_LIB_DIR "cudpp_hash_${MSVC_VERSION}${CUDA_SUFFIX}x64d.lib" "libcudpp_hash.so" OK_DBG  )

# 	#--------- Locate DLLS		
# 	if (OK_REL EQUAL 2)
# 		message ( STATUS "  Found LIBs (Release): ${LIB1_REL} ${LIB2_REL}" )	   
# 		set (OK_DLL "0")
# 		_FIND_FILE( CUDPP_DLL CUDPP_LIB_DIR "cudpp_${MSVC_VERSION}${CUDA_SUFFIX}x64.dll" "libcudpp.so" OK_DLL)   
# 		_FIND_FILE( CUDPP_DLL CUDPP_LIB_DIR "cudpp_hash_${MSVC_VERSION}${CUDA_SUFFIX}x64.dll" "libcudpp_hash.so" OK_DLL)  
# 	endif()
# 	if (OK_DBG EQUAL 2)
# 		message ( STATUS "  Found LIBs (Debug): ${LIB1_DEBUG} ${LIB2_DEBUG}" )	   
# 		_FIND_FILE( CUDPP_DLL CUDPP_LIB_DIR "cudpp_${MSVC_VERSION}${CUDA_SUFFIX}x64d.dll" "libcudpp.so" OK_DLL)   
# 		_FIND_FILE( CUDPP_DLL CUDPP_LIB_DIR "cudpp_hash_${MSVC_VERSION}${CUDA_SUFFIX}x64d.dll" "libcudpp_hash.so" OK_DLL)   
# 	endif()
